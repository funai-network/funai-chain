...
func init() {
	settlementDescGz = protodesc.BuildAndRegister(protodesc.FileDescriptor{
		...
		Messages: []protodesc.MsgEntry{
			...
			{Name: "MsgBatchReserve", Instance: MsgBatchReserve{}},
			{Name: "ReserveEntry", Instance: ReserveEntry{}},
			{Name: "MsgFraudProof", Instance: MsgFraudProof{}},
			{Name: "MsgSecondVerificationResult", Instance: MsgSecondVerificationResult{}},
			{Name: "MsgSecondVerificationResultBatch", Instance: MsgSecondVerificationResultBatch{}},
			{Name: "SecondVerificationBatchEntry", Instance: SecondVerificationBatchEntry{}},
			{Name: "MsgSecondVerificationResultBatchResponse", Instance: MsgSecondVerificationResultBatchResponse{}},
			...
			{Name: "MsgBatchReserveResponse", Instance: MsgBatchReserveResponse{}},
		...
		Services: []protodesc.ServiceEntry{
			{
				...
				Methods: []protodesc.MethodEntry{
					...
					{Name: "BatchReserve", InputType: ".funai.settlement.MsgBatchReserve", OutputType: ".funai.settlement.MsgBatchReserveResponse"},
					...
					{Name: "SubmitSecondVerificationResultBatch", InputType: ".funai.settlement.MsgSecondVerificationResultBatch", OutputType: ".funai.settlement.MsgSecondVerificationResultBatchResponse"},
				},
			},
			{
				Name: "Query",
...
// Descriptor indices below MUST match the position of each entry in the
// Messages list passed to BuildAndRegister above. Adding a new entry in the
// middle shifts every later index — keep these two ordered lists in sync.
...
func (m *MsgBatchReserve) Descriptor() ([]byte, []int)             { return settlementDescGz, []int{3} }
func (m *ReserveEntry) Descriptor() ([]byte, []int)                { return settlementDescGz, []int{4} }
func (m *MsgFraudProof) Descriptor() ([]byte, []int)               { return settlementDescGz, []int{5} }
func (m *MsgSecondVerificationResult) Descriptor() ([]byte, []int) { return settlementDescGz, []int{6} }
func (m *MsgSecondVerificationResultBatch) Descriptor() ([]byte, []int) {
	return settlementDescGz, []int{7}
}
func (m *SecondVerificationBatchEntry) Descriptor() ([]byte, []int) {
	return settlementDescGz, []int{8}
}
func (m *MsgSecondVerificationResultBatchResponse) Descriptor() ([]byte, []int) {
	return settlementDescGz, []int{9}
}
func (m *MsgDepositResponse) Descriptor() ([]byte, []int)         { return settlementDescGz, []int{10} }
func (m *MsgWithdrawResponse) Descriptor() ([]byte, []int)        { return settlementDescGz, []int{11} }
func (m *MsgBatchSettlementResponse) Descriptor() ([]byte, []int) { return settlementDescGz, []int{12} }
func (m *MsgBatchReserveResponse) Descriptor() ([]byte, []int)    { return settlementDescGz, []int{13} }
func (m *MsgFraudProofResponse) Descriptor() ([]byte, []int)      { return settlementDescGz, []int{14} }
func (m *MsgSecondVerificationResultResponse) Descriptor() ([]byte, []int) {
	return settlementDescGz, []int{15}
}
func (m *SettlementEntry) Descriptor() ([]byte, []int)  { return settlementDescGz, []int{16} }
func (m *VerifierResult) Descriptor() ([]byte, []int)   { return settlementDescGz, []int{17} }
func (m *InferenceAccount) Descriptor() ([]byte, []int) { return settlementDescGz, []int{18} }
func (m *BatchRecord) Descriptor() ([]byte, []int)      { return settlementDescGz, []int{19} }
func (m *QueryInferenceAccountRequest) Descriptor() ([]byte, []int) {
	return settlementDescGz, []int{20}
}
func (m *QueryInferenceAccountResponse) Descriptor() ([]byte, []int) {
	return settlementDescGz, []int{21}
}
func (m *QueryBatchRequest) Descriptor() ([]byte, []int)   { return settlementDescGz, []int{22} }
func (m *QueryBatchResponse) Descriptor() ([]byte, []int)  { return settlementDescGz, []int{23} }
func (m *QueryParamsRequest) Descriptor() ([]byte, []int)  { return settlementDescGz, []int{24} }
func (m *QueryParamsResponse) Descriptor() ([]byte, []int) { return settlementDescGz, []int{25} }
